...
const Skills = () => {
  ...
  const skills = [
    { name: "HTML", level: 90, color: "bg-gradient-primary" },
    { name: "CSS", level: 80, color: "bg-gradient-secondary" },
    { name: "JavaScript", level: 70, color: "bg-gradient-accent" },
    { name: "React", level: 75, color: "bg-gradient-primary" },
    { name: "Node.js", level: 65, color: "bg-gradient-secondary" },
    { name: "Database Design", level: 70, color: "bg-gradient-accent" },
    { name: "Video Editing", level: 80, color: "bg-gradient-primary" },
    { name: "Problem Solving", level: 85, color: "bg-gradient-secondary" }
  ];

  const technologies = [
    "JavaScript", "React", "Node.js", "Express", "MongoDB", "PostgreSQL",
    "HTML5", "CSS3", "Tailwind CSS", "Git", "Linux", "VS Code"
  ];
            ...
            <div className="space-y-8">
              ...
              <div className="glass-card p-6 rounded-2xl mt-8">
                ...
                <div className="flex flex-wrap gap-2">
                  {["TypeScript", "Next.js", "Docker", "AWS"].map((tech) => (
                    <span 
                      key={tech}
